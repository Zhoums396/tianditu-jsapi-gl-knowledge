...
适用于 **Polygon** 和 **MultiPolygon** 几何类型的 GeoJSON 数据。
...
| 属性 | 说明 | 示例值 |
|------|------|--------|
| fill-color | 填充颜色 | "#3388ff" |
| fill-opacity | 填充透明度 | 0.5 |
| fill-outline-color | 边框颜色 | "#1a73e8" |

## line 图层样式属性（边框）

| 属性 | 说明 | 示例值 |
|------|------|--------|
| line-color | 线颜色 | "#1a73e8" |
| line-width | 线宽度 | 2 |
